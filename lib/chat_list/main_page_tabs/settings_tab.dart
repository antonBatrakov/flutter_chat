...
Widget _logOutSettings(BuildContext context, LogOutSettingsModel settingsModel) =>
    Column(
      children: <Widget>[
        ListTile(
...
Widget _userSettings(UserSettingsModel settingsModel) => StreamBuilder(
            ...
            children: <Widget>[
              ListTile(
                ...
                leading: CircleAvatar(
                  backgroundImage: NetworkImage((snapshot.data as User).imgUrl),
                  backgroundColor: Colors.grey,
                ),
              ),
              Divider(
        ...
        StreamBuilder(
          ...
          builder: (context, snapshot) => ListTile(
            onTap: () {
              ...
              settingsModel
                  .updateValue(snapshot.data is bool ? !snapshot.data : false);
            },
            title: Text(settingsModel.settingName),
            trailing: Switch(
